export const CONFIG = {
  ...
  FEATURES: {
    ...
    BULK_DEPOSIT_NETWORKS: process.env.NEXT_PUBLIC_ENABLE_BULK_DEPOSIT_NETWORKS !== "false",
    MOMO_PAY_TRANSACTIONS: process.env.NEXT_PUBLIC_ENABLE_MOMO_PAY_TRANSACTIONS !== "false",
  },
};
